    ...
    <div class="scrollbar-inner">
        ...
        <div class="sidenav-header  d-flex  align-items-center">
            <a class="navbar-brand" href="<?= base_url() ?>">
                <img src="<?= BASE_ASSETS ?>thm2/images/brand/mainlogo.png" class="navbar-brand-img" alt="...">
            </a>
            <div class=" ml-auto ">
                <!-- Sidenav toggler -->
                ...
                <ul class="navbar-nav">
                    <?php
                        ...
                        if($this->session->userdata('payment_processor_short') == PROVIDER_PAYMENT_PAYSAFE_SHORT) {
                            ...
                            if(!$CI->orgnx_onboard_psf_model->checkOrganizationPSFIsCompleted($this->session->userdata('user_id'))){
                    ...
                    <li class="nav-item">
                        <?php $group = ['donations/index', 'batches/index', 'donations/recurring', 'payouts/index', 'statements/index']; ?>
                            ...
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item <?= permissionClassHide('donations/index') ?>">
                                    <a href="<?= base_url() ?>donations" class="nav-link <?= $view_index == 'donations/index' ? 'active' : '' ?>">
                                        ...
                                        <span class="sidenav-normal">Donations</span>
                                    </a>
                                </li>
                                <li class="nav-item <?= permissionClassHide('batches/index') ?>">
                                ...
                                <li class="nav-item <?= permissionClassHide('statements/index') ?>">
                    ...
                    <li class="nav-item <?= permissionClassHide('install/index') ?>">
                    ...
                    <li class="nav-item">
                        <?php $group = ['settings/integrations', 'settings/team']; ?>
                    ...
                    <li class="nav-item messaging_menu" style="<?= BASE_URL == 'https://app.chatgive.com/' ? 'display: none' : '' ?>">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse <?= permissionClassHideGroup($group) ?> <?= in_array($view_index, $group) ? 'show' : '' ?>" id="navbar-create">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item <?= permissionClassHide('pages/index') ?>">
                                    <a href="<?= base_url() ?>pages" class="nav-link <?= $view_index == 'pages/index' ? 'active' : '' ?>">
                                        <span class="sidenav-mini-icon"></span>
                                        <span class="sidenav-normal">Pages</span>
                                    </a>
                                </li>
                                <li class="nav-item <?= permissionClassHide('give_anywhere/index') ?>">
                    ...
                    <li class="nav-item <?= permissionClassHide('gbarber/create_app') ?>">
