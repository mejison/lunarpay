...
define('BASE_URL', 'http://localhost:3001/' . SYS_FOLDER);

//put here the absolute folder location of "uploads" folder
define('FOLDER_FILES_MAIN', '/var/www/html/app.lunarpay.com/application/uploads/');
...
define('BASE_URL_FILES', 'http://localhost:3001/' . SYS_FOLDER);
